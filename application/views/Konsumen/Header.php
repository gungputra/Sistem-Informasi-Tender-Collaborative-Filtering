...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="" class="logo">
      ...
      <span class="logo-mini"><b>E</b>TDR</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>e</b>-Tender</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url('assets/Konsumen/dist/img/user2-160x160.jpg') ?>" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo $this->session->userdata('nama') ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo base_url('assets/Konsumen/dist/img/user2-160x160.jpg') ?>" class="img-circle" alt="User Image">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="" id='btn_tender'>
          <a href="<?php echo base_url('Konsumen/Tender') ?>">
            <i class="fa fa-list"></i> <span>Tender Saya</span>
          </a>
        </li>
      </ul>
      <!-- search form -->
