<section class="section-intro padding-y-lg" style="background-image:url('<?php echo base_url('assets/image/background/2.jpg') ?>');background-size:100%;margin-top:30px">
  <div class="mx-auto">
   	<article class="white text-center mb-5">
   		<h1 class="display-3 mx-auto" style="width:70%;margin-bottom:50px">Selamat Datang di E-Tender</h1>
    	<p style="width:60%" class="mx-auto">Aplikasi e-tender merupakan aplikasi berbasis web yang dapat memertemukan antara konsumen yang ingin membuat suatu kerajinan dengan pengerajin atau produsen itu sendiri.</p>
...
<section class="section-content padding-y">
  <div class="container" >
    <div class="card text-white bg-primary mb-3">
      <div class="card-header"><h4><i class="fa fa-clock" style="margin-right:5px"></i>Tender Terbaru</h4></div>
      <div class="card-body bg2" style="color:black">
        <div class="row">
          <?php $i=1 ?>
        		...
        		<div class="col-md-3">
        			<figure class="card card-product">
        				...
        				<div class="bottom-wrap">
        					<p class="float-left"><span class="fa fa-calendar" style="margin-right:5px"></span><?php echo $key->tanggal_buka ?></p>
        					<a onclick="detail_tender(<?php echo $key->id_tender ?>)" class="btn btn-sm btn-primary float-right text-white"><i class="fa fa-search" style="margin-right:5px"></i>Detail</a>
        				</div> <!-- bottom-wrap.// -->
        			</figure>
        		</div> <!-- col // -->
            <?php $i++ ?>
